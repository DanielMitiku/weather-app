...
const fetchWeather = (location, unit) => {
    ...
    fetch(urlVar, { mode: 'cors'})
        ...
        .catch((err) => {
            showMessage('Location could not be found. Please try again later!', 'danger');
        });
};
...
//console.log(fetchWeather('London,uk'));
//const getWeather = async () => await fetchWeather('London,uk');
